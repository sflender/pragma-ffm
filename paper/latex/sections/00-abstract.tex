...
carries both a raw-neighbour attention path and a log-count magnitude readout, and show a
single such module beats the per-account FFM on both a synthetic (pattern) benchmark and
real click fraud (TalkingData, \num{+0.055} PR-AUC). We close with the productization
