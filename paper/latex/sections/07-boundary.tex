...
\paragraph{Count-type signals: a scalar suffices.} On Elliptic~\cite{weber2019elliptic}
(Bitcoin AML; 203K tx nodes) the
...
uses \emph{similarity-based neighbour selection}~\cite{dou2020caregnn,liu2021pcgnn}. This bounds our claim and points to selection as
